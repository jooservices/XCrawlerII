...
<template>
    <Card class="prime-movie-card-full prime-movie-card-full--dark" role="region" aria-label="PrimeVue movie card">
        <template #header>
            <div class="prime-movie-card-full__cover-wrap" role="button" tabindex="0" @click="handleCoverClick">
        ...
        <template #footer>
            <div class="prime-movie-card-full__footer">
                ...
                <div class="prime-movie-card-full__footer-row prime-movie-card-full__footer-row--single">
                    <Button size="small" :label="liked ? 'Liked' : 'Like'" :severity="liked ? 'danger' : 'secondary'" outlined @click="handleLike">
                        <template #icon>
                            <i :class="liked ? 'fas fa-heart' : 'far fa-heart'"></i>
                        </template>
                    </Button>
                    <Button size="small" :label="watchlisted ? 'Watchlisted' : 'Watchlist'" :severity="watchlisted ? 'warning' : 'secondary'" outlined @click="handleWatchlist">
                        <template #icon>
                ...
                <div class="prime-movie-card-full__footer-row prime-movie-card-full__footer-row--between">
                    <div class="prime-movie-card-full__rating-wrap">
                        <Rating v-model="userRating" :stars="5" size="small" title="Your rating" @update:modelValue="handleRate" />
